...
public class AppleArmorHelmetBipedEntityModel extends BipedEntityModel<LivingEntity> {
    final EquipmentSlot slot;

    public AppleArmorHelmetBipedEntityModel(ModelPart root, EquipmentSlot slot) {
        super(root);
        this.slot = slot;
    }
